...
function _detalhes:CreateOrOpenNewsWindow()
	...
	if (not frame) then
		...
		local frame_upper = CreateFrame ("scrollframe", nil, frame, BackdropTemplateMixin and "BackdropTemplate")
		local frame_lower = CreateFrame ("frame", "DetailsNewsWindowLower", frame_upper, BackdropTemplateMixin and "BackdropTemplate")
		...
		local slider = CreateFrame ("slider", "DetailsNewsWindowSlider", frame, BackdropTemplateMixin and "BackdropTemplate")

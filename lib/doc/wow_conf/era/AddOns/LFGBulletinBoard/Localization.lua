...
GBB.locales = {
	...
	ruRU = {	
		...
		["CboxChatStyle"] = "Используйте больше дизайна в стиле чата",
		...
		["CboxDontTrunicate"] = "Не обрезать сообщение",
		...
		["CboxShowClassIcon"] = "и показать значок",
		...
		["msgNbRequest"] = "%d запрос(ы) - нажмите, чтобы шепнуть - ШИФТ+нажатие /кто",
		["msgNewRequest"] = "Новый запрос от %s для подземелья %s.",
		["msgRequestHere"] = "Введите здесь ваше сообщение для поиска.",
